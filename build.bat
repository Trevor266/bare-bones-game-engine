...
if /i "%ReleaseBuild%"=="release" (
    ...
    clang -g -gcodeview -DDEBUG -D_CRT_SECURE_NO_WARNINGS -Iinclude main.c %Sources% source/engine-debug.c -o build\main.exe -luser32 -lgdi32 -lxinput -Wl,/subsystem:windows
)

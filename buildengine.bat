...
Set CommonSources=%CommonPath%dimensions.c %CommonPath%mouse.c %CommonPath%primitive_geometry.c %CommonPath%file.c %CommonPath%level.c %CommonPath%window.c  %CommonPath%pixelbuffer.c %CommonPath%bitmap.c
